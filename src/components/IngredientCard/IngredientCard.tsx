...
export default function IngredientCard({ ingredient, index, openModal }:any) {
  return (
  <div key={ingredient._id} className={`${styles.ingredientsCard} ml-4`} onClick={openModal}>
    <img src={ingredient.image} className={`${styles.ingredientsImg} ml-4 mr-4 `} alt='изображение ингридиета' onClick={openModal} />
